...
resource "aws_security_group" "eks_nodes" {
  ...
  description = "EKS worker nodes: inter-node + ALB to nodes"
  vpc_id      = aws_vpc.main.id
...
# STS endpoint — required for IRSA (ESO, cert-manager, Karpenter all call STS
# to exchange pod JWT for AWS credentials). Without this, STS calls route to the
# public endpoint which is blocked when no outbound internet path is available.
